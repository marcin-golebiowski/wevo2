...
/**
 * Tests for {@link ByteBSQFileReader}.
 *
 * @author Lukasz Krawiec (lmkrawiec@gmail.com)
 * @author Michal Anglart (anglart.michal@gmail.com)
 */
public final class ByteBSQFileReaderTest {
    ...
    public void testReadingWithHeader() throws IOException {
        final ByteBSQFileReader reader =
            new ByteBSQFileReader("testData/Byte.hdr", "testData/Byte.bsq");
        List<Byte> pixel;
    ...
    public void testReadingWithoutHeader() throws IOException {
        final ByteBSQFileReader reader =
            new ByteBSQFileReader("testData/Byte.bsq", 1, 3, 3, 3);
    ...
    /* TODO(lmkrawiec): write more tests */
