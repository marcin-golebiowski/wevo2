...
/**
 * Uniform crossover operator for photo rules.
 * @author Lukasz Krawiec (lmkrawiec@gmail.com)
 * @author Michal Anglart (anglart.michal@gmail.com)
 */
public final class PhotoRulesUniformCrossover implements
     ...
     */
    public PhotoRulesUniformCrossover(WevoRandom random) {
      this.random = random;
    }
    ...
    private void crossTwoChromosomes(List<List<Integer>> parent1,
      ...
      for (int i = 0; i < parent1.size(); i++) {
        ...
        int cutting = random.nextInt(0, Math.min(c1.size(), c2.size()));
        List<Integer> newc1 = new ArrayList<Integer>();
        List<Integer> newc2 = new ArrayList<Integer>();

        newc1.addAll(c1.subList(0, cutting));
        newc1.addAll(c2.subList(cutting, c2.size()));
        newc2.addAll(c2.subList(0, cutting));
        newc2.addAll(c1.subList(cutting, c1.size()));
     ...
     *  for each band set a crossing point is determined.
     *  Part of chromosome representing chosen band set is cut
     ...
     *   [[15,25], [20,50], [80,90]]
     *  we can get offsprings:
     *   [[10,25], [30,50], [80,90]]
     *   [[15,20], [20,40,50,60], [85,95]].
     */
