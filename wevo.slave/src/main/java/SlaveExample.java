...
public class SlaveExample {
  ...
  private final Logger logger =
      Logger.getLogger(SlaveExample.class.getCanonicalName());

  /** Size of the cache. Should be bigger than population size, of course. */
  ...
  public void doMain(final String[] args) {
    ...
    try {
      ...
      Slave<BinaryVector> slave = Slave.createSlave(
  ...
  private static List<CachedObjectiveFunction<BinaryVector>>
